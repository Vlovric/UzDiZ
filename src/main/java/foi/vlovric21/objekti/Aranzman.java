...
public class Aranzman {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getOznaka(), that.getOznaka()) &&
                Objects.equals(getNaziv(), that.getNaziv()) &&
                Objects.equals(getProgram(), that.getProgram()) &&
                Objects.equals(getPocetniDatum(), that.getPocetniDatum()) &&
                Objects.equals(getZavrsniDatum(), that.getZavrsniDatum()) &&
                Objects.equals(getVrijemeKretanja(), that.getVrijemeKretanja()) &&
                Objects.equals(getVrijemePovratka(), that.getVrijemePovratka()) &&
                Objects.equals(getCijena(), that.getCijena()) &&
                Objects.equals(getMinBrojPutnika(), that.getMinBrojPutnika()) &&
                Objects.equals(getMaxBrojPutnika(), that.getMaxBrojPutnika()) &&
                Objects.equals(getBrojNocenja(), that.getBrojNocenja()) &&
                Objects.equals(getDoplataZaJednokrevetnuSobu(), that.getDoplataZaJednokrevetnuSobu()) &&
                Objects.equals(getPrijevoz(), that.getPrijevoz()) &&
                Objects.equals(getBrojDorucka(), that.getBrojDorucka()) &&
                Objects.equals(getBrojRuckova(), that.getBrojRuckova()) &&
                Objects.equals(getBrojVecera(), that.getBrojVecera());
    }
